...
//static - there is no object of the class present ,main metod has to be static , so that the jvm can load the class into memory and call the main method without creating the instance of the class first. 
